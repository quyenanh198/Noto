...
import { dirname, isWithin, joinPath, noteTitle, validateName } from '../../core/vault/path';
...
export function MarkdownEditor({ path }: MarkdownEditorProps) {
  ...
  useEffect(() => {
    ...
    // Closing the browser tab does not blur the window first, so save on pagehide too.
